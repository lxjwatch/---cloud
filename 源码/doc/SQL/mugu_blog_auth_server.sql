...
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限表' ROW_FORMAT = Compact;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, '7adc94f4b38f45678461fc995ea21b14', 'guest', '不才陈某', 2, '$2a$10$8ecKl8JVIgA39pknoixkjOC4FRz0CJwYItS7UU0Y5zOa0wZN45CqS', '', '17621590365', 1, '123@163.com', '2019-10-10 13:41:22', '2022-02-09 11:07:23');
...
INSERT INTO `sys_user` VALUES (4, '94dd9d02befd4dac9d6e708ff92f7d82', 'root', '超级管理员', 1, '$2a$10$8ecKl8JVIgA39pknoixkjOC4FRz0CJwYItS7UU0Y5zOa0wZN45CqS', 'https://gitee.com/haoxr/image/raw/master/20210605215800.png', '17621210366', 1, '123@163.com', '2021-06-05 01:31:29', '2022-02-09 11:07:44');
...
CREATE TABLE `sys_user_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户和角色关联表' ROW_FORMAT = Compact;
